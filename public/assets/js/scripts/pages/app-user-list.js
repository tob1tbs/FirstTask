      ...
      buttons: [
        {
          ...
          text: feather.icons['external-link'].toSvg({ class: 'font-small-4 me-50 font-neue' }) + 'ექსპორტი',
          buttons: [
            {
              extend: 'pdf',
        ...
        {
          text: 'ახალი მომხმარებლის დამატბა',
          className: 'add-new btn btn-primary font-neue',
          attr: {
